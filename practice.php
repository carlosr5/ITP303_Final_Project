...
<body class="d-flex flex-column min-vh-100">
    ...
    <!-- Openings from DB -> JS file -> randomly display the openings -->

    <div class="container">
        <div class="content-row row">
            <div id="opening-name" class="col col-md-6 col-12 input-text mb-2">
            </div>
            <div class="col col-6"></div>
            <div class="text-center col col-12 col-md-6">
                <div id="practice-board" class="w-100"></div>
            </div>
            <div class="text text-center col col-12 col-md-6 my-auto input-text">
                <div id="status"></div>
                <label>Moves Made:</label>
                <div id="pgn"></div>
                <button id="reset-btn" class="btn viridian">Reset Board</button>
            </div>
        </div>
    </div>
