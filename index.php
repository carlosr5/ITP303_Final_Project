...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container">
        <div class="content-row row">
            <div class="text text-center col col-12 col-md-6 my-auto input-text mb-3 my-md-auto">
                Practice memorizing common openings such as the Italian Game or Caro Kann. Each opening goes up to 8
                moves in. Made by a chess hobbyist who wants
                to get out of 800 hell.
            </div>
            <div class="chessboard text-center col col-12 col-md-6">
